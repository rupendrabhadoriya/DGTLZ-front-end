...
const PlanTab = () => {
  ...
  useEffect(async ()=> {
    ...
    console.log('getUserData ---', response.details.iskyc);
    if (response.details.iskyc === true) {
      setIskyc('true');
    }
    setIsLoader('false');
  }, []);
    ...
    <div className="pricing py-5">
      <div className="container">
          ...
          <div className="row mt-5">
            { isLoader == 'true' ?
              <> <img style={{height: 50, width: 60}} src={loading} alt="" className="img-fluid loading-load offset-md-5" /> </>
            :
            <>
